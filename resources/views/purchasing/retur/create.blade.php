<x-app-layout>
    <x-slot name="header">Tambah Retur</x-slot>

    <div class="max-w-4xl">
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <form action="{{ route('retur-purchasing.store') }}" method="POST" x-data="{
                penerimaanId: '',
                items: [],
                loadItems() {
                ...
                <div class="mb-5">
                    ...
                    <template x-if="items.length === 0">
                        <p class="text-sm text-gray-400 mt-2">Pilih penerimaan terlebih dahulu</p>
                    </template>
                    <template x-for="(item, index) in items" :key="index">
                        <div class="flex gap-3 items-center mb-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div class="flex-[2]">
                                ...
                                <span class="text-xs text-gray-400 ml-2">(diterima: <span x-text="item.qty_diterima"></span>)</span>
                            </div>
                            <div class="w-20">
