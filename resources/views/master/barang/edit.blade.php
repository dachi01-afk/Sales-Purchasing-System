<x-app-layout>
    ...
    <div class="max-w-3xl">
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <form action="{{ route('barang.update', $barang->sku) }}" method="POST">
                @csrf @method('PUT')

                <div class="mb-5">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">SKU</label>
                    <input type="text" name="sku" value="{{ old('sku', $barang->sku) }}" class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('sku') border-red-500 dark:border-red-500 @enderror">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="nama_barang" value="{{ old('nama_barang', $barang->nama_barang) }}" class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('nama_barang') border-red-500 dark:border-red-500 @enderror">
                ...
                <div class="mb-5">
                    ...
                    <input type="number" step="0.01" name="harga_standar" value="{{ old('harga_standar', $barang->harga_standar) }}" class="bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 @error('harga_standar') border-red-500 dark:border-red-500 @enderror">
