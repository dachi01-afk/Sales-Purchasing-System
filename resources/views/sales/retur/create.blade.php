<x-app-layout>
    <x-slot name="header">Tambah Retur Sales</x-slot>

    <div class="max-w-4xl">
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <form action="{{ route('retur-sales.store') }}" method="POST" x-data="{
                doId: '',
                items: [],
                loadItems() {
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div class="flex gap-3 items-center mb-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <div class="flex-[2]">
                                ...
                                <span class="text-xs text-gray-400 ml-2">(dikirim: <span x-text="item.qty_dikirim"></span>)</span>
                            </div>
                            <div class="w-20">
