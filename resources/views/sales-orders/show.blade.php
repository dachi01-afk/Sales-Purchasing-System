<x-app-layout>
    <x-slot name="header">SO Detail #{{ $salesOrder->id }}</x-slot>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm p-6">
            <dl class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <dd class="text-sm font-medium text-gray-900 dark:text-white">#{{ $salesOrder->id }}</dd>
                </div>
                <div>
                    <dt class="text-sm text-gray-500 dark:text-gray-400">Customer</dt>
                    <dd class="text-sm font-medium text-gray-900 dark:text-white">{{ $salesOrder->customer->name }}</dd>
                </div>
                <div>
                    <dt class="text-sm text-gray-500 dark:text-gray-400">Date</dt>
                    <dd class="text-sm font-medium text-gray-900 dark:text-white">{{ $salesOrder->date->format('d/m/Y') }}</dd>
                </div>
                <div>
